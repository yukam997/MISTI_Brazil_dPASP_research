...
class two_concat_Net(nn.Module):
    def __init__(self):
        super().__init__()
...
class three_channels_Net(nn.Module):
    def __init__(self):
        super().__init__()
...
class four_gathered_Net(nn.Module):
    def __init__(self):
        super().__init__()
        self.conv1 = nn.Conv2d(1, 6, 5)
        self.pool = nn.MaxPool2d(2, 2)
        self.conv2 = nn.Conv2d(6, 16, 5)
        self.fc1 = nn.Linear(16 * 11 * 11, 480)
...
class five_channels_Net(nn.Module):
    def __init__(self):
        super().__init__()
...
class five_concat_Net(nn.Module):
    def __init__(self):
        super().__init__()
